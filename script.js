let input = document.getElementById('input'), // input/output button
    number = document.querySelectorAll('.calculator__keys button'), // number buttons
    operator = document.querySelectorAll('.key--operator button'), // operator buttons
    result = document.getElementById('result'), // equal button
    clear = document.getElementById('clear'), // clear button
    resultDisplayed = "0"; // flag to keep an eye on what output is displayed
